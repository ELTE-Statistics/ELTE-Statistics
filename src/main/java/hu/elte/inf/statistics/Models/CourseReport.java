...
/**
 * Represents CourseReport Class Report includes course name, comment difficulty and usefulness
 * level
 */
public class CourseReport {
     ...
     * @param comment
     * @param difficulty
     * @param usefulness Constructor of CourseReport Class with four parameters
     */
