...
Drupal.Education.updateEqualHeight = function() {
  ...
  this.hTimeout = window.setTimeout(
    function() {
      ...
      Drupal.Education.resetEqualHeight($('#sidebar-home1-wrapper > .grid-inner .block-views'));
	  Drupal.Education.resetEqualHeight($('#sidebar-home2-wrapper > .grid-inner .block-views'));
      ...
      if ($(window).width() > Drupal.Education.supportedScreens[2]) {
        ...
        //Drupal.Education.equalHeight2($('#main-content > .grid-inner'), $('#sidebar-home1-wrapper > .grid-inner'));
        Drupal.Education.equalHeight3( 
          $('#main-content > .grid-inner'),
          $('#sidebar-home1-wrapper > .grid-inner'),
		  $('#sidebar-home2-wrapper > .grid-inner'),
          $('#sidebar-home1-wrapper > .grid-inner .block-views'),
		  $('#sidebar-home2-wrapper > .grid-inner .block-views')
        );
...
Drupal.Education.equalHeight3 = function(el1, el2, els){
  ...
  Drupal.Education.updateLogoSize = function(slideshowHeight) {
    ...
    if ($(window).width() < this.supportedScreens[4]) {
      logo.css('width', 2 * slideshowHeight * logo.width() / logo.height());
    }
  }
